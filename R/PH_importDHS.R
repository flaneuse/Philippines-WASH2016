# Philippines DHS Activity Design -----------------------------------------
...
# Analysis to focus on Mindanao region
#
...
hh_raw = read_dta('~/Documents/USAID/Philippines/rawdata/PH_DHS2013/phhr61dt/PHHR61FL.DTA')
child_raw = read_dta('~/Documents/USAID/Philippines/rawdata/PH_DHS2013/phkr61dt/PHKR61FL.DTA')
...
write.csv(toilet_types, '~/GitHub/Philippines-WASH2016/dataout/DHS_toilet_types.csv')

water_types = attr(hh_raw$hv201, 'labels')
write.csv(water_types, '~/GitHub/Philippines-WASH2016/dataout/DHS_water_types.csv')
